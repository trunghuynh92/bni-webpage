...
export default function MCRelationsPage() {
  return (
    <main>
      <Hero title="MC RELATIONS" subtitle="Building strong member connections" buttons={[{ label: "Your Role – Easy Checklist", href: "#" }]} />
