...
export default function MentorCoordinatorPage() {
  return (
    <main>
      <Hero title="MENTOR COORDINATOR" subtitle="Guiding new members to success" buttons={[{ label: "Your Role – Easy Checklist", href: "#" }]} />
